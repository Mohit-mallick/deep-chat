...
Depending on the service you choose component assets such as buttons and intro panel will automatically be changed to suit the chosen service.
Their configuration can still be overwritten manually.

### `directConnection` {#directConnection}

- Type: \{<br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`openAI?: OpenAI`](#OpenAI), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`huggingFace?: HuggingFace`](#HuggingFace), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`azure?: Azure`](#Azure), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`cohere?: Cohere`](#Cohere), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`assemblyAI?: AssemblyAI`](#AssemblyAI) <br />
  \}

Settings for connecting to popular AI APIs. This object MUST have one of the above properties defined.

### `OpenAI` {#OpenAI}

- Type: \{`key: string`\}

Settings for connecting to OpenAI's API. <br />
`key` is your OpenAI API key. <br />

### `HuggingFace` {#HuggingFace}

- Type: \{`key: string`\}

Settings for connecting to HuggingFace's API. <br />
`key` is your HuggingFace API key. <br />

### `Azure` {#Azure}

- Type: \{`key: string`\}

Settings for connecting to Azure's API. <br />
`key` is your Azure API key. <br />

### `Cohere` {#Cohere}

- Type: \{`key: string`\}

Settings for connecting to Cohere's API. <br />
`key` is your Cohere API key. <br />

### `AssemblyAI` {#AssemblyAI}

- Type: \{`key: string`\}

Settings for connecting to AssemblyAI's API. <br />
`key` is your AssemblyAI API key. <br />
