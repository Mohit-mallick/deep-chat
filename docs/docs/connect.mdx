...
The `stream` property enables you to connect to streaming APIs. This allows you to receive responses in real-time as they are being generated.

## Direct Connection

The `directConnection` property enables you to connect to APIs that do not require any request formatting.
